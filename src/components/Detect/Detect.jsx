...
const Detect = () => {
  ...
  const enableCam = useCallback(() => {
    ...
    if (webcamRunning === true) {
      ...
      // Remove empty values and handle null checks
  ...
  useEffect(() => {
    async function loadGestureRecognizer() {
      try {
        ...
        // Get the model file using fetch with relative path
        const modelPath = window.location.origin + '/sign_language_recognizer_25-04-2023.task';
        ...
        console.log("Model file loaded successfully, size:", modelBuffer.byteLength);
